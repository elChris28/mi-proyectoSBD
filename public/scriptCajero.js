...
const platosMenu = {
  ...
  Platos_Comidas: {
    Platos_CARTA: [
      { nombre: "LOMO DE CARNE", precio: 15 },
      { nombre: "SALTADO DE POLLO", precio: 13 },
      { nombre: "LOMO DE CARNE A LO POBRE", precio: 18 },
      { nombre: "SALTADO DE POLLO A LO POBRE", precio: 17 },
      { nombre: "BISTECK A LO POBRE", precio: 20 },
      { nombre: "POLLO A LA PLANCHA A LO POBRE", precio: 18 },
      { nombre: "POLLO A LA PLANCHA ", precio: 13 },
      { nombre: "TALLARIN SALTADO DE CARNE", precio: 14 },
      { nombre: "TALLARIN SALTADO DE POLLO", precio: 13 },
    ],
    Platos_POBRE: [
      { nombre: "LOMO DE CARNE A LO POBRE (FRITO)", precio: 18 },
      { nombre: "SALTADO DE POLLO A LO POBRE (INGLESA)", precio: 17 },
      { nombre: "BISTECK A LO POBRE (FRITO)", precio: 20 },
      { nombre: "BISTECK A LO POBRE (INGLESA)", precio: 20 },
      { nombre: "POLLO A LA PLANCHA A LO POBRE (FRITO)", precio: 18 },
      { nombre: "POLLO A LA PLANCHA A LO POBRE (INGLESA)", precio: 18 },
    ...
    Platos_SOPAS: [
      { nombre: "MINUTA DE CARNE C/ LECHE", precio: 11 },
      { nombre: "MINUTA DE POLLO C/LECHE", precio: 11 },
      { nombre: "MINUTA DE CARNE Y POLLO C/LECHE", precio: 12 },
      { nombre: "SUSTANCIA DE POLLO ", precio: 10 },
      { nombre: "SUSTANCIA DE CARNE ", precio: 10 },
      { nombre: "SUSTANCIA DE CARNE Y POLLO", precio: 11 },
      { nombre: "DIETA", precio: 10 },
    ],
    Platos_BROASTER: [
      { nombre: "ALITA + ARROZ + PAPA", precio: 10 },
      { nombre: "ALITA + PAPA", precio: 10 },
      ...
      { nombre: "CHICHARRON DE POLLO (PURA PAPA)", precio: 14 },
      { nombre: "CHICHARRON DE POLLO (CON ARROZ)", precio: 14 },
    ...
    Platos_SALCHIPAPAS: [
      ...
      { nombre: "SALCHIPAPA MIXTA", precio: 11 },
      { nombre: "SALCHIPAPA A LO POBRE", precio: 12 },
      { nombre: "SALCHIPAPA MIXTA A LO POBRE (FRITO)", precio: 13 },
      { nombre: "SALCHIPAPA MIXTA A LO POBRE (INGLESA)", precio: 13 },
  ...
  PARA_LLEVAR_TIO:{
    Platos_CARTA: [
      { nombre: "LLEVAR - LOMO DE CARNE", precio: 15 },
      { nombre: "LLEVAR - SALTADO DE POLLO", precio: 13 },
      { nombre: "LLEVAR - LOMO DE CARNE A LO POBRE", precio: 18 },
      { nombre: "LLEVAR - SALTADO DE POLLO A LO POBRE", precio: 17 },
      { nombre: "LLEVAR - BISTECK A LO POBRE", precio: 20 },
      { nombre: "LLEVAR - POLLO A LA PLANCHA A LO POBRE", precio: 18 },
      { nombre: "LLEVAR - POLLO A LA PLANCHA ", precio: 13 },
      { nombre: "LLEVAR - TALLARIN SALTADO DE CARNE", precio: 14 },
      { nombre: "LLEVAR - TALLARIN SALTADO DE POLLO", precio: 13 },
    ],
    Platos_POBRE: [
      { nombre: "LLEVAR - LOMO DE CARNE A LO POBRE (FRITO)", precio: 18 },
      { nombre: "LLEVAR - SALTADO DE POLLO A LO POBRE (INGLESA)", precio: 17 },
      { nombre: "LLEVAR - BISTECK A LO POBRE (FRITO)", precio: 20 },
      { nombre: "LLEVAR - BISTECK A LO POBRE (INGLESA)", precio: 20 },
      { nombre: "LLEVAR - POLLO A LA PLANCHA A LO POBRE (FRITO)", precio: 18 },
      { nombre: "LLEVAR - POLLO A LA PLANCHA A LO POBRE (INGLESA)", precio: 18 },
    ...
    Platos_SOPAS: [
      { nombre: "LLEVAR - MINUTA DE CARNE C/ LECHE", precio: 11 },
      { nombre: "LLEVAR - MINUTA DE POLLO C/LECHE", precio: 11 },
      { nombre: "LLEVAR - MINUTA DE CARNE Y POLLO C/LECHE", precio: 12 },
      { nombre: "LLEVAR - SUSTANCIA DE POLLO ", precio: 10 },
      { nombre: "LLEVAR - SUSTANCIA DE CARNE ", precio: 10 },
      { nombre: "LLEVAR - SUSTANCIA DE CARNE Y POLLO", precio: 11 },
      { nombre: "LLEVAR - DIETA", precio: 10 },
    ],
    Platos_BROASTER: [
      { nombre: "LLEVAR - ALITA + ARROZ + PAPA", precio: 10 },
      { nombre: "LLEVAR - ALITA + PAPA", precio: 10 },
      ...
      { nombre: "LLEVAR - CHICHARRON DE POLLO (PURA PAPA)", precio: 14 },
      { nombre: "LLEVAR - CHICHARRON DE POLLO (CON ARROZ)", precio: 14 },
    ...
    Platos_SALCHIPAPAS: [
      ...
      { nombre: "LLEVAR - SALCHIPAPA MIXTA", precio: 11 },
      { nombre: "LLEVAR - SALCHIPAPA A LO POBRE", precio: 12 },
      { nombre: "LLEVAR - SALCHIPAPA MIXTA A LO POBRE (FRITO)", precio: 13 },
      { nombre: "LLEVAR - SALCHIPAPA MIXTA A LO POBRE (INGLESA)", precio: 13 },
...
function gestionarMesa(mesa) {
    ...
    (plato, index) => `
      <div class="plato-card">
        <div class="plato-info">
          ...
          <div class="detalle-precio">S/ ${plato.precio} x ${plato.cantidad}</div>
        </div>
        <div class="acciones">
  ...
  // Mostrar el total de los platos de la mesa
    ...
    platosList.innerHTML += `<div class="total-mesa"><strong>Total: S/ ${totalPlatos.toFixed(2)}</strong></div>`;
...
function actualizarHistorialVentas() {
  ventasList.innerHTML = ventas
    ...
    mostrarResumenMetodosPago(); // <- esta línea nueva
}

function mostrarResumenMetodosPago() {
    const resumen = {};
    let totalGeneral = 0;
  
    ventas.forEach((venta) => {
      if (!resumen[venta.metodoPago]) {
        resumen[venta.metodoPago] = 0;
      }
